import { TopSourcesType } from "@/app/sites/[site_id]/page";
...
export function TopChannels({sources}: TopChannelsProps) {
          ...
          {sources.map((source) => (
            ...
            >
              <div className="flex gap-3 items-center">
                <div
                  className={`w-9 h-9 rounded-lg flex items-center justify-center border border-gray-100 shadow-sm bg-blue-50`}
                >
                  <svg
                    width="18"
                    height="18"
